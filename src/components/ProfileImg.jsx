import { useColorMode, useMediaQuery,Stack, Circle ,Flex , Image, Box, Heading , Text, Divider, Center} from '@chakra-ui/react';
...
function ProfileImg() {
  ...
  return (
    <Stack mt={isNotSmallerScreen?"12vh":"10vh"} ml={isNotSmallerScreen?"10vw":"7"}>
        ...
        <Circle /*position={isNotSmallerScreen?'absolute':'initial'} */bg="blue.200"  h={isNotSmallerScreen?"350px":"300px"} w={isNotSmallerScreen?"350px":"300px"}>
            {/* <Circle position='absolute' bg="green.100" h="300px" w='300px'></Circle> */}
            <Image src="https://avatars.githubusercontent.com/u/39216973?v=4" h={isNotSmallerScreen?"310px":"260px"} w={isNotSmallerScreen?"310px":"260px"} borderRadius="100%" opacity="1.0"></Image>
            </Circle>
            {isNotSmallerScreen?
        <Center height="400" ml="10vw">
        <Divider orientation={isNotSmallerScreen?'vertical':"horizontal"} borderColor={isDark?"white":"black"}></Divider>
        </Center>:""
          }
        <Box ml={isNotSmallerScreen?"10vw":"6"} mt="50px" w={isNotSmallerScreen?"35vw":"80vw"}>
        ...
        <Text mt={isNotSmallerScreen?"10px":"10px"} fontSize={isNotSmallerScreen?"2xl":"2xl"}>MERN Stack Developer</Text>
